...
По ощущениям, если говорить о типовом SaaS бэкенде без полиморфизма не обойтись. Множество переиспользуемых объектов (к примеру, dto) зачастую просто обязывают создавать базовый класс и переиспользовать под конкретный эндпоинт.
...
### Резюме
Узнал и повторил много полезных правил. Забираю цикломатическую сложность как инструмент для повышения надежности и простоты кода одновременно. 
