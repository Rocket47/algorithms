...
public class SD115
{
    ...
    ///
    /// Рекурсивные вызовы:
    /// левая часть массива не больше pivot; QuickSort(arr, left, j); левая часть отсортирована
    /// правая часть массива не меньше pivot; QuickSort(arr, i, right); правая часть отсортирована
    /// </remarks>
